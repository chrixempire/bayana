...
export function CreateAccountForm({ onSwitchToSignIn, copyKey = "signup" }: CreateAccountFormProps) {
    ...
    <div className="mx-auto flex w-full max-w-[396px] flex-col items-center gap-8">
      ...
      <div className="flex w-full flex-col gap-8">
        <div className="flex flex-col gap-3 text-center">
          <div key={copyKey} className="auth-entry-anim-copy flex flex-col gap-3">
