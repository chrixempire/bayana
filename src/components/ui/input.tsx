  ...
  return (
    ...
    >
      ...
      <input
        ...
        type={type}
        className={cn(
          "w-full min-w-0 border-0 bg-transparent [border-radius:inherit] text-sm font-normal leading-[22px] tracking-[-0.1px] outline-none placeholder:text-input-placeholder disabled:cursor-not-allowed",
